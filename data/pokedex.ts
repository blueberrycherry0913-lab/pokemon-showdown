export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	ninetales: {
		...
		abilities: { 0: "Flash Fire", H: "Magic Guard" },
		heightm: 1.1,
		weightkg: 19.9,
		color: "Yellow",
		prevo: "Vulpix",
	...
	dodrio: {
		...
		abilities: { 0: "Tangled Feet", 1: "Early Bird", H: "Tangled Feet" },
		heightm: 1.8,
		weightkg: 85.2,
		color: "Brown",
		prevo: "Doduo",
	...
	exeggutor: {
		...
		abilities: { 0: "Telepathy", 1: "Harvest", H: "TBD" },
		heightm: 2,
		weightkg: 120,
		color: "Yellow",
		prevo: "Exeggcute",
	...
	seaking: {
		...
		name: "Seaking",
		types: ["Water"],
		baseStats: {hp: 85, atk: 95, def: 65, spa: 65, spd: 80, spe: 80},
		abilities: { 0: "Swift Swim", 1: "Water Veil", H: "Lightning Rod" },
		heightm: 1.3,
		weightkg: 39,
		color: "Red",
