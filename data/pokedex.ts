export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	omastar: {
		...
		types: ["Rock", "Water"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: {hp: 70, atk: 50, def: 145, spa: 115, spd: 95, spe: 60},
	...
	kabutops: {
		...
		types: ["Rock", "Water"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: {hp: 75, atk: 120, def: 100, spa: 65, spd: 70, spe: 105},
		abilities: { 0: "Swift Swim", 1: "Battle Armor", H: "Weak Armor" },
		heightm: 1.3,
		weightkg: 40.5,
		color: "Brown",
	...
	aerodactyl: {
		...
		types: ["Rock", "Flying"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 80, atk: 105, def: 85, spa: 60, spd: 75, spe: 130 },
