export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	alakazam: {
		...
		types: ["Psychic"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: {hp: 55, atk: 45, def: 45, spa: 145, spd: 95, spe: 120},
		abilities: { 0: "Synchronize", 1: "Inner Focus", H: "Magic Guard" },
		heightm: 1.5,
		weightkg: 48,
		color: "Brown",
	...
	machamp: {
		...
		types: ["Fighting"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: {hp: 95, atk: 145, def: 90, spa: 50, spd: 85, spe: 70},
	...
	hatterene: {
		...
		types: ["Psychic", "Fairy"],
		gender: "F",
		baseStats: { hp: 60, atk: 135, def: 95, spa: 90, spd: 105, spe: 30 },
	...
	annihilape: {
		...
		name: "Annihilape",
		types: ["Fighting", "Ghost"],
		baseStats: { hp: 110, atk: 125, def: 80, spa: 50, spd: 90, spe: 90 },
