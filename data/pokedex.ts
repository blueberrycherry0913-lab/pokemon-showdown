export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	arbok: {
		...
		name: "Arbok",
		types: ["Poison"],
		baseStats: {hp: 80, atk: 100, def: 70, spa: 65, spd: 80, spe: 80},
		abilities: { 0: "Intimidate", 1: "Shed Skin", H: "Unnerve" },
		heightm: 3.5,
		weightkg: 65,
		color: "Purple",
	...
	nidoqueen: {
		...
		types: ["Poison", "Ground"],
		gender: "F",
		baseStats: {hp: 100, atk: 90, def: 95, spa: 65, spd: 95, spe: 75},
	...
	nidoking: {
		...
		types: ["Poison", "Ground"],
		gender: "M",
		baseStats: {hp: 90, atk: 110, def: 75, spa: 85, spd: 70, spe: 90},
	...
	arcanine: {
		...
		types: ["Fire"],
		genderRatio: { M: 0.75, F: 0.25 },
		baseStats: {hp: 105, atk: 125, def: 75, spa: 100, spd: 75, spe: 105},
	...
	crobat: {
		...
		name: "Crobat",
		types: ["Poison", "Flying"],
		baseStats: { hp: 85, atk: 90, def: 70, spa: 85, spd: 70, spe: 130 },
