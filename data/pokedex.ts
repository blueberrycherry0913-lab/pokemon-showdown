export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	farfetchdkanto: {
		...
		abilities: { 0: "Steadfast", 1: "Scaleward", H: "Harder They Fall" },
		heightm: 0.8,
		weightkg: 15,
		color: "Brown",
		eggGroups: ["Flying", "Field"],
	...
	marowak: {
		...
		name: "Marowak",
		types: ["Ground", "Normal"],
		baseStats: { hp: 70, atk: 110, def: 90, spa: 45, spd: 75, spe: 100 },
	...
	osteokhan: {
		...
		name: "Osteokhan",
		types: ["Ground", "Ghost"],
		baseStats: { hp: 100, atk: 130, def: 100, spa: 45, spd: 75, spe: 40 },
