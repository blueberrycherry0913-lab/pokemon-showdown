export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	sandslash: {
		...
		abilities: { 0: "Sand Veil", 1: "Rough Skin", H: "Breaking Point" },
		heightm: 1,
		weightkg: 29.5,
		color: "Yellow",
		prevo: "Sandshrew",
	...
	graveler: {
		...
		name: "Graveler",
		types: ["Rock"],
		baseStats: {hp: 90, atk: 95, def: 140, spa: 45, spd: 45, spe: 35},
	...
	hypno: {
		...
		name: "Hypno",
		types: ["Psychic", "Dark"],
		baseStats: {hp: 85, atk: 75, def: 75, spa: 100, spd: 115, spe: 70},
	...
	kingler: {
		...
		name: "Kingler",
		types: ["Water"],
		baseStats: {hp: 60, atk: 130, def: 115, spa: 50, spd: 50, spe: 75},
		abilities: { 0: "Hyper Cutter", 1: "Shell Armor", H: "Sheer Force" },
		heightm: 1.3,
		weightkg: 60,
		color: "Red",
	...
	mrmime: {
		...
		name: "Mr. Mime",
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 50, atk: 45, def: 65, spa: 100, spd: 125, spe: 90},
