export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	hitmonlee: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 75, atk: 120, def: 80, spa: 35, spd: 60, spe: 95},
		abilities: { 0: "Limber", 1: "Iron Foot", H: "Champion" },
		heightm: 1.5,
		weightkg: 49.8,
		color: "Brown",
		prevo: "Tyrogue",
	...
	hitmonchan: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 75, atk: 120, def: 60, spa: 35, spd: 80, spe: 95},
		abilities: { 0: "Limber", 1: "Iron Fist", H: "Champion" },
		heightm: 1.4,
		weightkg: 50.2,
		color: "Brown",
		prevo: "Tyrogue",
