export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	parasect: {
		...
		name: "Parasect",
		types: ["Grass", "Poison"],
		baseStats: {hp: 60, atk: 95, def: 85, spa: 60, spd: 80, spe: 30},
	...
	osteokhan: {
		...
		abilities: { 0: "Mold Breaker", 1: "Lightning Rod", H: "Protective Soul" },
		heightm: 1,
		weightkg: 45,
		color: "Brown",
		prevo: "Cubone",
	...
	magnezone: {
		...
		abilities: { 0: "Magnet Pull", 1: "Analytic", H: "Reactive Levitation" },
		heightm: 1.2,
		weightkg: 180,
		color: "Gray",
		prevo: "Magneton",
	...
	sirfetchd: {
		...
		name: "Sirfetch\u2019d",
		types: ["Fighting"],
		baseStats: { hp: 70, atk: 100, def: 70, spa: 40, spd: 70, spe: 60 },
		abilities: { 0: "Steadfast", 1: "Scaleward", H: "Hero" },
		heightm: 0.8,
		weightkg: 117,
		color: "White",
