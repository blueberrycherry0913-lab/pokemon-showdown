...
export const Moves: import('../sim/dex-moves').MoveDataTable = {
	...
	drillpeck: {
		...
		pp: 20,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, distance: 1, metronome: 1, drill: 1 },
		target: "any",
		type: "Flying",
		contestType: "Cool",
	},
	drillrun: {
		...
		pp: 10,
		priority: 0,
		flags: { contact: 1, protect: 1, mirror: 1, metronome: 1, drill: 1 },
		critRatio: 2,
		target: "normal",
		type: "Ground",
		contestType: "Tough",
	...
	uproar: {
		...
		pp: 10,
		priority: 0,
		flags: { protect: 1, mirror: 1, sound: 1, metronome: 1, nosleeptalk: 1, failinstruct: 1 },
		self: {
